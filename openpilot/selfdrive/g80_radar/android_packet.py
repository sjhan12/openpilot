...
def build_render_packet(state: dict) -> dict:
  return {
    ...
    'scc_front_match':state.get('scc_front_match',{}),'associations':state.get('corner_front_associations',[]),'fusion_stats':state.get('corner_fusion_stats',{}),'view_presets':{'short':{'rear_m':-15,'front_m':35,'metric_1to1':True},'long':{'rear_m':-50,'front_m':100,'metric_1to1':True},'wide':{'rear_m':-30,'front_m':70,'lateral_m':12.6,'metric_1to1':False}}}
